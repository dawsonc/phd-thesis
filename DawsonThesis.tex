...
\hypersetup{%
	pdfsubject={Automatic design tools for optimizing robotic and cyberphysical systems.},
	% Change this to briefly state topic of your thesis 
% 
	pdfkeywords={Massachusetts Institute of Technology, MIT, automatic differentiation, differentiable simulation, end-to-end optimization, safety verification, failure diagnosis},
...
%	
	pdfcontactemail={charles.dwsn@gmail.com},
...
\title{Breaking things so you don't have to: risk assessment and failure prediction for cyber-physical AI}
...
\Supervisor{Chuchu Fan}{Assistant Professor of Aeronautics and Astronautics}
