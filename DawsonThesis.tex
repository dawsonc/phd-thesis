...
\usepackage[style=ieee,maxbibnames=10,sorting=none,backend=biber]{biblatex}% style=ext-numeric-comp,articlein=false,giveninits=true
...
% \include{chapters/local_methods}
