...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=0.7\linewidth]{iros/mission_1_comparison.png}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=0.7\linewidth]{iros/mission_2_comparison.png}
