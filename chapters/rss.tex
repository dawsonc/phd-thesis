\chapter{General-purpose design optimization with statistical robustness certificates}\label{ch:rss}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.8\linewidth]{rss/agv_simulation_stacked.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\linewidth]{rss/agv_worst_case_error.png}
...
\begin{figure}[b!]
    \centering
    \includegraphics[width=0.5\linewidth]{rss/mam_example.png}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\linewidth]{rss/agv_gevd_comp.png}

    \includegraphics[width=0.99\linewidth]{rss/mam_gevd_comp_friction.png}
